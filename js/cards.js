var cards = { 
    'blue-eyes': {
        'id': 'blue-eyes',
        'type': 'monsters',
        'file': 'blue_eyes_white_dragon.png',
    ...
    'tri-horned-dragon': {
        'id': 'tri-horned-dragon',
        'type': 'monsters',
        'file': 'tri_horned_dragon.png',
    ...
    'gaia-the-fierce-knight': {
        ...
        'type': 'monsters',
        'file': 'gaia_the_fierce_knight.png',
    ...
    'mammoth-graveyard': {
        'id': 'mammoth-graveyard',
        'type': 'monsters',
        'file': 'mammoth_graveyard.png',
    ...
    'red-eyes': {
        'id': 'red-eyes',
        'type': 'monsters',
        'file': 'red_eyes_black_dragon.png',
    ...
    'trial-of-nightmare': {
        'id': 'trial-of-nightmare',
        'type': 'monsters',
        'file': 'trial_of_nightmare.png',
...
function isMonsterCard(cardId) {
    var c = getCardDef(cardId);
    return c && c.type === 'monsters';
}

function isSpellCard(cardId) {
    var c = getCardDef(cardId);
    return c && c.type === 'spells';
}

function isTrapCard(cardId) {
    var c = getCardDef(cardId);
    return c && c.type === 'traps';
}